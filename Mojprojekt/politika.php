...
<html>
    ...
    <body>
        ...
        <div id="prvi"> 
            ...
            <h2 class="pNaslovi">Stranica: politika</h2>          
            <h3 class="pNaslovi"> 
                <?php
        ...
        <article>
            ...
            while ($red = mysqli_fetch_array($podaci))
            {
                ...
                else 
                {
                  ...
                  if($pomagalo==1) echo "<a class=\"clanci\" href=\"clanak.php?id=" . $red['id'] . "\"> <p class=\"sredina\"><img class=\"slika\" src=\"prikaziSliku.php?id=".$red['id']."\" alt=\"Slika iz baze\"><br> <b>".$red['naslov']."</b><br>".$red['kratki']."</p></a>";
                  if($pomagalo==2)
                  {
