...
<html>
    <head>
        ...
        <meta name="description" content="administratorska stranica" />
    ...
    <body>
        ...
        <div id="prvi"> 
            ...
            <h2 class="pNaslovi">Administracijska stranica</h2>          
            <h3 class="pNaslovi"> 
                <?php
        ...
        <article>
            ...
            $naredba= "SELECT * FROM projekt WHERE kategorija='politika'";
            ...
            while ($red = mysqli_fetch_array($podaci))
            {
                ...
                else 
                {
                  if($pomagalo==0)
                  {
                    ...
                    echo " <p class=\"lijevo\"><img class=\"slika\" src=\"prikaziSliku.php?id=".$red['id']."\" alt=\"Slika iz baze\"><br> <b>".$red['naslov']."</b><br>".$red['kratki']."<br><form action=\"Brisi.php\" method=\"post\"><input type=\"hidden\" name=\"argument\" value=".$red['id']."><button type=\"submit\">Obriši članak</button></form><br><form action=\"Promjeni.php\" method=\"post\"><input type=\"hidden\" name=\"argument\" value=".$red['id']."><button type=\"submit\">Promjeni članak</button></form></p>";
                  } 
                  if($pomagalo==1) echo "<p class=\"sredina\"><img class=\"slika\" src=\"prikaziSliku.php?id=".$red['id']."\" alt=\"Slika iz baze\"><br> <b>".$red['naslov']."</b><br>".$red['kratki']."<br><form action=\"Brisi.php\" method=\"post\"><input type=\"hidden\" name=\"argument\" value=".$red['id']."><button type=\"submit\">Obriši članak</button></form><br><form action=\"Promjeni.php\" method=\"post\"><input type=\"hidden\" name=\"argument\" value=".$red['id']."><button type=\"submit\">Promjeni članak</button></form></p>";
                  if($pomagalo==2)
                  {
                    echo "<p class=\"desno\"><img class=\"slika\" src=\"prikaziSliku.php?id=".$red['id']."\" alt=\"Slika iz baze\"><br> <b>".$red['naslov']."</b><br>".$red['kratki']."<br><form action=\"Brisi.php\" method=\"post\"><input type=\"hidden\" name=\"argument\" value=".$red['id']."><button type=\"submit\">Obriši članak</button></form><br><form action=\"Promjeni.php\" method=\"post\"><input type=\"hidden\" name=\"argument\" value=".$red['id']."><button type=\"submit\">Promjeni članak</button></form></p>";
                    echo "</section><br>";
                  }
                  $pomagalo++;
                }
            ...
            $pomagalo=0;
            $konekcija = mysqli_connect("localhost", "root","", "baza") or die('Greška pri spajanju na bazu');
            $naredba= "SELECT * FROM projekt WHERE kategorija='sport'";
            $podaci=mysqli_query($konekcija, $naredba);
            while ($red = mysqli_fetch_array($podaci))
            {
                if($pomagalo==3) $pomagalo=0;
